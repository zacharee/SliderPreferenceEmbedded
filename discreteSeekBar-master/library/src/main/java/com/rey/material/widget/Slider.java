...
public class Slider extends View implements ThemeManager.OnThemeChangedListener{
    ...
    protected void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        for(int i = 0, count = a.getIndexCount(); i < count; i++){
            ...
            else if (attr == R.styleable.Slider_sl_transformAnimDuration) {
                mTransformAnimationDuration = a.getInteger(attr, 0);
            }
        ...
        if (mTransformAnimationDuration < 0) {
            mTransformAnimationDuration = context.getResources().getInteger(android.R.integer.config_mediumAnimTime);
        }
    ...
    public void setTravelAnimationDuration(int duration) {
        mTravelAnimationDuration = duration;
        invalidate();
    }

    public int getTravelAnimationDuration() {
        return mTravelAnimationDuration;
    }

    public void setTransformAnimationDuration(int duration) {
        mTransformAnimationDuration = duration;
        invalidate();
    }

    public int getTransformAnimationDuration() {
        return mTransformAnimationDuration;
    }
